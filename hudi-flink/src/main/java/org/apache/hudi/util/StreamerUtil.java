...
public class StreamerUtil {
  ...
  public static Schema getSourceSchema(HoodieFlinkStreamer.Config cfg) {
    return new FilebasedSchemaProvider(HoodieOptions.fromStreamerConfig(cfg)).getSourceSchema();
  }
  ...
  public static KeyGenerator createKeyGenerator(Configuration conf) throws IOException {
    String keyGeneratorClass = conf.getString(HoodieOptions.KEYGEN_CLASS);
    try {
