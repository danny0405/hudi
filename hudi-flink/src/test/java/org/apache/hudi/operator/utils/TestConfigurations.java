...
public class TestConfigurations {
  ...
  public static Configuration getDefaultConf(String tablePath) {
    ...
    conf.setString(HoodieOptions.PATH, tablePath);
    conf.setString(HoodieOptions.READ_SCHEMA_FILE_PATH,
        Objects.requireNonNull(Thread.currentThread()
            .getContextClassLoader().getResource("test_read_schema.avsc")).toString());
    conf.setString(HoodieOptions.TABLE_NAME, "TestHoodieTable");
    conf.setString(HoodieOptions.PARTITION_PATH_FIELD, "partition");
    return conf;
  }
}
